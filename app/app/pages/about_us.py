...
def about_us_page() -> rx.Component:
    return rx.container(
        ...
        rx.vstack(
            ...
            # About Us Content
            rx.heading("About Toyota", size="9", margin_top="20px"),  # Adjusted size to a valid value
            rx.text("🚗🌍 Driven by Innovation, Built for the Future", size="4", font_weight="bold"),  # Adjusted size to a valid value
            ...
            rx.heading("What We’re Known For", size="4", margin_top="15px"),  # Adjusted size to a valid value
            rx.unordered_list(
            ...
            rx.heading("Awards & Recognitions 🏆", size="4", margin_top="15px"),  # Adjusted size to a valid value
            rx.unordered_list(
            ...
            rx.heading("The Road Ahead 🚀", size="4", margin_top="15px"),  # Adjusted size to a valid value
            rx.text(
            ...
            rx.center(
                rx.link(
                    rx.button("Join the Toyota Family Today!", 
                    background_color="#800000"),  # Maroon color
